...
다음 형식의 JSON으로 응답해주세요:
{
  ...
  "projectAnalysis": {
    "complexity": "프로젝트 복잡도 평가 (1-10점)",
    "completeness": "프로젝트 완성도 평가 (1-10점)",
    "innovation": "창의성과 혁신성 평가 (1-10점)"
  },
  "overallScore": 85,
  "nextSteps": ["구체적인 개선사항1", "구체적인 개선사항2", "구체적인 개선사항3"]
}

분석 시 다음 사항들을 중점적으로 고려해주세요:
1. 실제 코드의 구조, 가독성, 베스트 프랙티스 준수
2. 문서화 품질 (README, 주석 등)
3. 프로젝트의 완성도와 실용성
4. 기술 스택 활용의 적절성
5. GitHub 관리 상태 (커밋 히스토리, Stars, Forks 등)
6. 전반적인 개발 역량과 성장 가능성
